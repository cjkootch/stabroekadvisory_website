...
export const posts: BlogPost[] = [
  {
    slug: "lca-non-compliance-fines-guyana",
    title: "GY$50 Million and Counting: The Real Cost of LCA Non-Compliance in Guyana",
    excerpt:
      "Non-compliance with Guyana's Local Content Act carries fines up to GY$50 million per offence, and the Secretariat is actively enforcing. Here's what every contractor needs to know.",
    date: "March 28, 2026",
    readTime: "7 min read",
    category: "Compliance",
    image: "https://images.pexels.com/photos/5668858/pexels-photo-5668858.jpeg?w=800&q=80",
    content: `The Local Content Act of 2021 is not advisory guidance. It is law, and it has teeth.
...
The Secretariat's enforcement capacity is growing. The time to get your compliance house in order is now, not after the first penalty notice arrives.`,
  ...
  {
    slug: "guide-to-half-yearly-report-guyana",
    title: "A Complete Guide to Filing Your LCA Half-Yearly Report in Guyana",
    excerpt:
    ...
    category: "Guide",
    image: "https://images.pexels.com/photos/590022/pexels-photo-590022.jpeg?w=800&q=80",
    content: `The Half-Yearly Local Content Report is the backbone of Guyana's Local Content Act compliance framework. Filed twice per year, it requires every contractor, subcontractor, and licensee to report detailed data on expenditure, employment, and capacity development, disaggregated by Guyanese and non-Guyanese participation.
...
For companies that prefer not to handle filings themselves, Stabroek Advisory's managed service covers the entire process, from data collection through submission and Secretariat follow-up.`,
  ...
  {
    slug: "why-guyana-oil-sector-needs-dedicated-compliance-software",
    title: "Why Guyana's Oil Sector Needs Dedicated Compliance Software, Not Another Spreadsheet",
    excerpt:
    ...
    readTime: "6 min read",
    category: "Industry",
    image: "https://images.pexels.com/photos/1181467/pexels-photo-1181467.jpeg?w=800&q=80",
    content: `When Guyana's Local Content Act was enacted in 2021, the petroleum sector was still in its early operational phase. ExxonMobil's Liza Phase 1 FPSO was producing roughly 120,000 barrels per day. The Local Content Register had a few hundred companies. The Secretariat was still building its enforcement infrastructure.
