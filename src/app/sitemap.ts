...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticPages = [
    ...
    { url: `${base}/bid-services`, lastModified: new Date(), changeFrequency: "monthly" as const, priority: 0.95 },
    { url: `${base}/execution-suite`, lastModified: new Date(), changeFrequency: "monthly" as const, priority: 0.9 },
